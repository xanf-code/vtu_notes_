...
import 'package:vtunotes/todo/scopedmodel/todo_list_model.dart';
import 'package:vtunotes/todo/gradient_background.dart';
import 'package:vtunotes/todo/task_progress_indicator.dart';
import 'package:vtunotes/todo/page/add_task_screen.dart';
import 'package:vtunotes/todo/model/hero_id_model.dart';
import 'package:vtunotes/todo/model/task_model.dart';
import 'package:vtunotes/todo/route/scale_route.dart';
import 'package:vtunotes/todo/utils/color_utils.dart';
import 'package:vtunotes/todo/utils/datetime_utils.dart';
import 'package:vtunotes/todo/page/detail_screen.dart';
import 'package:vtunotes/todo/component/todo_badge.dart';
  ...
  Widget build(BuildContext context) {
    var app = MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: TextTheme(
          headline: GoogleFonts.ubuntu(fontSize: 32.0, fontWeight: FontWeight.w400),
          title: GoogleFonts.ubuntu(fontSize: 28.0, fontWeight: FontWeight.w500),
