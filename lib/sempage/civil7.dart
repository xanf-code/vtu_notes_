...
class Civil7 extends StatefulWidget {
  @override
  _Civil7State createState() => _Civil7State();
}

class _Civil7State extends State<Civil7> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("CIVILSEM7").orderBy("Subject");
