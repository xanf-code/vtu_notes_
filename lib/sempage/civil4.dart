...
class Civil4 extends StatefulWidget {
  @override
  _Civil4State createState() => _Civil4State();
}

class _Civil4State extends State<Civil4> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("CIVILSEM4").orderBy("Subject");
