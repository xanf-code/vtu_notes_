...
class EEE3 extends StatefulWidget {
  @override
  _EEE3State createState() => _EEE3State();
}

class _EEE3State extends State<EEE3> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("EEESEM3").orderBy("id");
          ...
          return Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  _subjects[index].data["description_name"],
                  style: GoogleFonts.ubuntu(
                      fontSize: 12,
                      letterSpacing: 1.5,
                      height: 2,
