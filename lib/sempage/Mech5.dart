...
class MECH5 extends StatefulWidget {
  @override
  _MECH5State createState() => _MECH5State();
}

class _MECH5State extends State<MECH5> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("MECHSEM5").orderBy("id");
