...
class Civil3 extends StatefulWidget {
  @override
  _Civil3State createState() => _Civil3State();
}

class _Civil3State extends State<Civil3> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("CIVILSEM3").orderBy("Subject");
