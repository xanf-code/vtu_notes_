...
class PElectrical extends StatefulWidget {
  @override
  _PElectricalState createState() => _PElectricalState();
}

class _PElectricalState extends State<PElectrical> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("PElectrical");
