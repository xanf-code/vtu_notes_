...
class ChemMech extends StatefulWidget {
  @override
  _ChemMechState createState() => _ChemMechState();
}

class _ChemMechState extends State<ChemMech> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("CMech");
