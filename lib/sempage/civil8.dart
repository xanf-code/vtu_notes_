...
class Civil8 extends StatefulWidget {
  @override
  _Civil8State createState() => _Civil8State();
}

class _Civil8State extends State<Civil8> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("CIVILSEM8").orderBy("Subject");
