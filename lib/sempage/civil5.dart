...
class Civil5 extends StatefulWidget {
  @override
  _Civil5State createState() => _Civil5State();
}

class _Civil5State extends State<Civil5> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("CIVILSEM5").orderBy("Subject");
