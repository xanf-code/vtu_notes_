...
class Civil6 extends StatefulWidget {
  @override
  _Civil6State createState() => _Civil6State();
}

class _Civil6State extends State<Civil6> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("CIVILSEM6").orderBy("Subject");
