...
class _MarkingPageState extends State<MarkingPage> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("Marking").orderBy("Code");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Marking Scheme",style: GoogleFonts.ubuntu(fontWeight: FontWeight.w600,color: Theme.of(context).brightness == Brightness.dark
            ? Colors.white
            : Color(0xff121212),)),
        elevation: 0,
                ...
                ButtonBar(
                  ...
                  children: <Widget>[
                    FlatButton(
                      ...
                      onPressed: () => launch(_subjects[index].data["Marking"]),
                      child: Column(
                        children: <Widget>[
                    ...
                    FlatButton(
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(4.0)),
                      onPressed: () {
                        Share.share('Check Out ${_subjects[index].data["Branches"]} Marking Scheme ${_subjects[index].data["Marking"]}', subject: 'Look what I made!');
                      },
                      child: Column(
                        children: <Widget>[
                          Icon(Icons.share),
