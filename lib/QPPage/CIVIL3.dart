...
class CIV3QP extends StatefulWidget {
  @override
  _CIV3QPState createState() => _CIV3QPState();
}

class _CIV3QPState extends State<CIV3QP> {
  Firestore _firestore = Firestore.instance;
  List<DocumentSnapshot> _subjects = [];
  bool _loadingSubjects = true;

  _getSubjects() async {
    Query q = _firestore.collection("CIVILSEM3QP").orderBy("Subject");
