...
class CSE7QP extends StatefulWidget {
  @override
  _CSE7QPState createState() => _CSE7QPState();
}

class _CSE7QPState extends State<CSE7QP> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("CSSEM7QP").orderBy("Subject");
