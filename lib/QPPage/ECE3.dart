...
class ECE3QP extends StatefulWidget {
  @override
  _ECE3QPState createState() => _ECE3QPState();
}

class _ECE3QPState extends State<ECE3QP> {
  Firestore _firestore = Firestore.instance;
  List<DocumentSnapshot> _subjects = [];
  bool _loadingSubjects = true;

  _getSubjects() async {
    Query q = _firestore.collection("ECESEM3QP").orderBy("Subject");
