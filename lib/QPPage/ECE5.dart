...
class ECE5QP extends StatefulWidget {
  @override
  _ECE5QPState createState() => _ECE5QPState();
}

class _ECE5QPState extends State<ECE5QP> {
  Firestore _firestore = Firestore.instance;
  List<DocumentSnapshot> _subjects = [];
  bool _loadingSubjects = true;

  _getSubjects() async {
    Query q = _firestore.collection("ECESEM5QP").orderBy("Subject");
