...
class MECH7QP extends StatefulWidget {
  @override
  _MECH7QPState createState() => _MECH7QPState();
}

class _MECH7QPState extends State<MECH7QP> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("MECHSEM7QP").orderBy("Subject");
