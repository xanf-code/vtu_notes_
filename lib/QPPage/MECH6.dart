...
class MECH6QP extends StatefulWidget {
  @override
  _MECH6QPState createState() => _MECH6QPState();
}

class _MECH6QPState extends State<MECH6QP> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("MECHSEM6QP").orderBy("Subject");
