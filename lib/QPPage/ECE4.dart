...
class ECE4QP extends StatefulWidget {
  @override
  _ECE4QPState createState() => _ECE4QPState();
}

class _ECE4QPState extends State<ECE4QP> {
  Firestore _firestore = Firestore.instance;
  List<DocumentSnapshot> _subjects = [];
  bool _loadingSubjects = true;

  _getSubjects() async {
    Query q = _firestore.collection("ECESEM4QP").orderBy("Subject");
