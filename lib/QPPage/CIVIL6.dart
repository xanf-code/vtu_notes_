...
class CIV6QP extends StatefulWidget {
  @override
  _CIV6QPState createState() => _CIV6QPState();
}

class _CIV6QPState extends State<CIV6QP> {
  Firestore _firestore = Firestore.instance;
  List<DocumentSnapshot> _subjects = [];
  bool _loadingSubjects = true;

  _getSubjects() async {
    Query q = _firestore.collection("CIVILSEM6QP").orderBy("Subject");
