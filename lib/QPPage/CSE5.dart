...
class CSE5QP extends StatefulWidget {
  @override
  _CSE5QPState createState() => _CSE5QPState();
}

class _CSE5QPState extends State<CSE5QP> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("CSSEM5QP").orderBy("Subject");
