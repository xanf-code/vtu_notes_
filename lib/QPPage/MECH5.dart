...
class MECH5QP extends StatefulWidget {
  @override
  _MECH5QPState createState() => _MECH5QPState();
}

class _MECH5QPState extends State<MECH5QP> {
  Firestore _firestore = Firestore.instance;
  List<DocumentSnapshot> _subjects = [];
  bool _loadingSubjects = true;

  _getSubjects() async {
    Query q = _firestore.collection("MECHSEM5QP").orderBy("Subject");
            ...
            ? Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Theme park engineers are involved in designing, building, lighting,\nand even controlling the crowd flow in theme parks around the world.",
                  ...
                  return Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: _subjects[index].data["decjan16"] != "Null"
                            ? FlatButton(
                                color: Colors.deepPurple,
                                onPressed: () =>
                                    launch(_subjects[index].data["decjan16"]),
                                child: Text(
                                  "Dec/Jan 16",
                                  style: GoogleFonts.ubuntu(
                                      fontSize: 14,
                            ...
                            : FlatButton(
                                ...
                                child:
                                    Text("Dec/Jan 16 (Will be updated Soon)"),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(10),
                                ),
                              ),
