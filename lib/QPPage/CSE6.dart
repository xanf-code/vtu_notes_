...
class CSE6QP extends StatefulWidget {
  @override
  _CSE6QPState createState() => _CSE6QPState();
}

class _CSE6QPState extends State<CSE6QP> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("CSSEM6QP").orderBy("Subject");
