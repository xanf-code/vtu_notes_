...
class MECH4QP extends StatefulWidget {
  @override
  _MECH4QPState createState() => _MECH4QPState();
}

class _MECH4QPState extends State<MECH4QP> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("MECHSEM4QP").orderBy("Subject");
