...
class CIV4QP extends StatefulWidget {
  @override
  _CIV4QPState createState() => _CIV4QPState();
}

class _CIV4QPState extends State<CIV4QP> {
  Firestore _firestore = Firestore.instance;
  List<DocumentSnapshot> _subjects = [];
  bool _loadingSubjects = true;

  _getSubjects() async {
    Query q = _firestore.collection("CIVILSEM4QP").orderBy("Subject");
