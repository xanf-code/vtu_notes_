...
class MECH3QP extends StatefulWidget {
  @override
  _MECH3QPState createState() => _MECH3QPState();
}

class _MECH3QPState extends State<MECH3QP> {
  ...
  _getSubjects() async {
    Query q = _firestore.collection("MECHSEM3QP").orderBy("Subject");
