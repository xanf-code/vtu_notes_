...
class ECE6QP extends StatefulWidget {
  @override
  _ECE6QPState createState() => _ECE6QPState();
}

class _ECE6QPState extends State<ECE6QP> {
  Firestore _firestore = Firestore.instance;
  List<DocumentSnapshot> _subjects = [];
  bool _loadingSubjects = true;

  _getSubjects() async {
    Query q = _firestore.collection("ECESEM6QP").orderBy("Subject");
