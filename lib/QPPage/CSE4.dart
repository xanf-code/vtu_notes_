...
class CSE4QP extends StatefulWidget {
  @override
  _CSE4QPState createState() => _CSE4QPState();
}

class _CSE4QPState extends State<CSE4QP> {
  Firestore _firestore = Firestore.instance;
  List<DocumentSnapshot> _subjects = [];
  bool _loadingSubjects = true;

  _getSubjects() async {
    Query q = _firestore.collection("CSSEM4QP").orderBy("Subject");
