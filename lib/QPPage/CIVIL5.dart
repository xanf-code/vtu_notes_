...
class CIV5QP extends StatefulWidget {
  @override
  _CIV5QPState createState() => _CIV5QPState();
}

class _CIV5QPState extends State<CIV5QP> {
  Firestore _firestore = Firestore.instance;
  List<DocumentSnapshot> _subjects = [];
  bool _loadingSubjects = true;

  _getSubjects() async {
    Query q = _firestore.collection("CIVILSEM5QP").orderBy("Subject");
